...
if (isset($_POST['ubah'])) {
	...
	if (!empty($lokasifoto)) {
		...
		$koneksi->query("UPDATE produk SET namaproduk='$_POST[nama]',idkategori='$_POST[idkategori]',hargaproduk='$_POST[harga]',fotoproduk='$namafoto', deskripsiproduk='$_POST[deskripsi]', stokproduk='$_POST[stok]' WHERE idproduk='$_GET[id]'");
	} else {
		$koneksi->query("UPDATE produk SET namaproduk='$_POST[nama]', idkategori='$_POST[idkategori]',hargaproduk='$_POST[harga]', deskripsiproduk='$_POST[deskripsi]', stokproduk='$_POST[stok]' WHERE idproduk='$_GET[id]'");
	}
