...
if (isset($_POST['save'])) {
	...
	$koneksi->query("INSERT INTO produk
		(namaproduk,idkategori, hargaproduk,fotoproduk,deskripsiproduk, stokproduk)
		VALUES('$_POST[nama]','$_POST[idkategori]','$_POST[harga]','$namafoto','$_POST[deskripsi]','$_POST[stok]')");
