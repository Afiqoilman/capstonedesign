						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select name="kota" class="form-control" required id="kota" onchange="check()">
									...
									<option value="Pungging">Pungging</option>
								</select>
							</div>
						</div>
						<div class="col-md-6">
...
if (isset($_POST["checkout"])) {
	...
	$koneksi->query(
		"INSERT INTO pembelian(notransaksi,
				id, tanggalbeli, totalbeli, alamatpengiriman, kota, ongkir, catatan, statusbeli, waktu)
				VALUES('$notransaksi','$id', '$tanggalbeli', '$totalbeli', '$alamatpengiriman','$kota','$ongkir','$catatan', 'Belum Bayar', '$waktu')"
...
<script>
    function check() {
        ...
        if (val == 'Mojosari') {
            document.getElementById('ongkir').value = "8000";
        } else if (val == 'Jetis') {
            document.getElementById('ongkir').value = "9000";
        } else if (val == 'Ngoro') {
            document.getElementById('ongkir').value = "10000";
        } else if (val == 'Pungging') {
            document.getElementById('ongkir').value = "12000";
        }
